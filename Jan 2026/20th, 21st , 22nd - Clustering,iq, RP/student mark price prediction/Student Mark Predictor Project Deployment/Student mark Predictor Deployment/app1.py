...
app = Flask(__name__)
model = joblib.load(r"C:\Users\A3MAX SOFTWARE TECH\Desktop\WORK\2. DATASCIENCE PROJECT\4. Students mark prediction\Student Mark Predictor Project Deployment\Student mark Predictor Deployment\student_mark_predictor.pkl")
