...
app = Flask(__name__)
model = joblib.load(r"C:\Users\santo\OneDrive\Desktop\Data science\Jan 2026\19th jan Student mark Predictor Deployment (1)\Student mark Predictor Deployment\student_marks_model.pkl")
